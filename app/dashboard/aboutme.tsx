...
export default function AboutMe(){
    return(
        <>
            ...
            <div className='z-10 relative text-center sm:text-lg lg:text-xl base:hidden md-1:block'>
                ...
                <div className='flex justify-center items-center'>
                    ...
                    <p className="leading-7 [&:not(:first-child)]:mt-6 inline m-5 mr-28">
                        ...
                        <a href="https://www.medstarhealth.org/innovation-and-research/medstar-health-research-institute"><span className="leading-7 [&:not(:first-child)]:mt-6 inline text-accent-hover font-bold"> Medstar Health Research Institute</span></a>. 
