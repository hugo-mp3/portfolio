        ...
        <>
            <div className='text-center relative pt-20 z-10'>
                ...
                <div className='grid grid-cols-8 justify-items-center gap-x-0 gap-y-4 mb-10 mt-10 ml-56 mr-56'>
                    ...
                    <FaJava className='h-[2.6rem] w-[2.6rem] text-red-800 hover:scale-150'/>
                    <FaNode className='h-[2.6rem] w-[2.6rem] text-lime-500 hover:scale-150'/>
                    <FaWindows className='h-[2.6rem] w-[2.6rem] text-sky-400 hover:scale-150'/>
                    <FaLinux className='h-[2.6rem] w-[2.6rem] text-slate-500 hover:scale-150'/>
                    ...
                    <IoLogoJavascript className='h-[2.6rem] w-[2.6rem] text-yellow-400 hover:scale-150' />
                    <IoLogoGithub className='h-[2.6rem] w-[2.6rem] dark:text-gray-200 text-slate-900 hover:scale-150' />
                    <SiExpress className='h-[2.6rem] w-[2.6rem] dark:text-gray-50 text-slate-800 hover:scale-150' />
                    <SiFlask className='h-[2.6rem] w-[2.6rem] text-slate-500 hover:scale-150' />
                    ...
                    <SiShadcnui className='h-[2.6rem] w-[2.6rem] dark:text-gray-100 text-slate-950 hover:scale-150' />
                    <BiLogoPostgresql className='h-[2.6rem] w-[2.6rem] text-cyan-800 hover:scale-150' />
                    <DiMongodb className='h-[2.6rem] w-[2.6rem] text-green-500 hover:scale-150' />
                    <GrDocker className='h-[2.6rem] w-[2.6rem] text-cyan-400 hover:scale-150' />
                </div>
            </div>
        </>
    )
